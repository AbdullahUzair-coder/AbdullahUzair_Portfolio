    ...
    try {
      ...
      if (settings) {
        ...
        if (settings.profileImage) {
          setProfileImagePreview(settings.profileImage.startsWith('http') ? settings.profileImage : `${import.meta.env.VITE_API_URL}${settings.profileImage}`)
        }
              ...
              {currentCvUrl && (
                <div className="mb-8">
                  ...
                  <div className="flex items-center justify-between bg-dark-700/50 rounded-xl p-4">
                    ...
                    <a
                      href={currentCvUrl.startsWith('http') ? currentCvUrl : `${import.meta.env.VITE_API_URL}${currentCvUrl}`}
                      target="_blank"
